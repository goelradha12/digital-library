        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-purple-900 bg-clip-text">
                Library Resources
              </h3>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <a
                  href="mailto:library@knowledgehub.com"
                  className="text-gray-400 hover:text-blue-400 transition-colors duration-200 flex items-center gap-2 text-sm"
                >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col items-center md:items-start space-y-4">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="bg-blue-950/30 p-2 rounded-full hover:bg-blue-900/20 transition-colors duration-200"
                  >
              ...
              <div className="text-center md:text-right space-y-2">
                <p className="text-sm text-gray-400">
                  © 2025 Digital Library Management System.
                  <br />
                  All rights reserved.
                </p>
                <p className="text-xs text-gray-500">
                  Developed with dedication by Team
                  <br />
                  Radha, Akriti, Surbhi, Shivangi, Hariom, & Ankit
                </p>
              </div>
            </div>
          </div>
