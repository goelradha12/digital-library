        ...
        <>
            ...
            <div className="bg-[#f2e4e3] min-h-screen pt-30 pb-12">
                <div className="container mx-auto max-w-7xl px-6 space-y-16">
                    ...
                    <section>
                        <h2 className="text-3xl md:text-5xl font-serif font-light mb-8 text-center" style={{ color: '#A56F6E' }}>
                            Latest Publishes
                        </h2>
                        {loading ? (
                    ...
                    <section>
                        ...
                        <div className="relative mb-10">
                            <h2 className="text-3xl md:text-5xl font-serif font-light text-center" style={{ color: '#A56F6E' }}>
                                All Books
                            </h2>
                            ...
                            <div className="mb-6">
                                <div className="bg-blue-50 border border-blue-200 rounded-lg px-4 py-3">
                                    <p className="text-sm text-blue-800">
                                        <span className="font-semibold">{filteredBooks.length}</span> of <span className="font-semibold">{books.length}</span> books found
                                        {searchTerm && <span className="ml-1">matching <strong>"{searchTerm}"</strong></span>}
                                        {selectedCategory && <span className="ml-1">in <strong>{selectedCategory}</strong></span>}
                                    </p>
                                </div>
                            </div>
                        )}
