...
import { ThumbsUp, Download, Star, BookOpen, Heart, ClipboardList, Book, Award, UserCheck } from 'lucide-react';
...
const likedBooks = [
  { title: "The Midnight Library", cover: "https://placehold.co/120x180/F0F0F0/A56F6E?text=Book+1" },
  { title: "Project Hail Mary", cover: "https://placehold.co/120x180/F0F0F0/A56F6E?text=Book+2" },
  { title: "Where the Crawdads Sing", cover: "https://placehold.co/120x180/F0F0F0/A56F6E?text=Book+3" },
];

const downloadedBooks = [
  { title: "A Game of Thrones", cover: "https://placehold.co/120x180/F0F0F0/A56F6E?text=Book+4" },
  { title: "To Kill a Mockingbird", cover: "https://placehold.co/120x180/F0F0F0/A56F6E?text=Book+5" },
];

const reviewsGiven = [
  { bookTitle: "The Midnight Library", rating: 5, reviewText: "An amazing read that makes you think about life and choices." },
  { bookTitle: "Project Hail Mary", rating: 4, reviewText: "A fantastic sci-fi adventure, hard to put down!" },
];
          ...
          <aside className="lg:w-1/4 bg-white rounded-xl shadow-lg p-8 h-fit">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 text-gray-600 text-sm">
                ...
                <p>
                  <span className="font-semibold text-gray-800">Reward Points:</span> {user.Reward_Points}
                </p>
              </div>
            </div>
            <div className="mt-8 space-y-4">
              <h2 className="text-xl font-serif font-medium text-[#A56F6E]">Accessibility</h2>
              <div className="space-y-3 text-gray-600 text-sm">
          ...
          <main className="lg:w-3/4 space-y-12">
            {isSubscriber ? (
              <>
                  ...
                  <div className="flex gap-6 overflow-x-auto whitespace-nowrap py-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
                    {likedBooks.map((book) => (
                      <div key={book.title} className="w-24 flex-shrink-0 text-center">
                        <img src={book.cover} alt={book.title} className="w-full h-36 object-cover rounded-md shadow-md mb-2" />
                ...
                <section className="bg-white rounded-xl shadow-lg p-8">
                  <h2 className="text-2xl font-serif font-medium text-[#A56F6E] mb-6 flex items-center gap-2">
                    <Download size={24} /> Downloaded Books
                  </h2>
                  <div className="flex gap-6 overflow-x-auto whitespace-nowrap py-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
                ...
                <section className="bg-white rounded-xl shadow-lg p-8">
                  <h2 className="text-2xl font-serif font-medium text-[#A56F6E] mb-6 flex items-center gap-2">
                    <UserCheck size={24} /> AI Recommended Books
                  </h2>
                  <div className="flex gap-6 overflow-x-auto whitespace-nowrap py-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
              ...
              <div className="bg-white rounded-xl shadow-lg p-10 border-2 border-dashed border-gray-300">
                <h2 className="text-2xl font-serif font-medium text-gray-700 mb-4">{ctaMessage.title}</h2>
